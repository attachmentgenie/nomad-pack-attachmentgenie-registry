...
variable "service_name" {
  description = "The service name for the temporal application"
  type        = string
  default     = "temporal"
}
...
variable "task" {
  description = "Details configuration options for the temporal task."
  type = object({
    driver  = string
    image   = string
    version = string
  ...
  default = {
    driver  = "docker",
    image   = "ghcr.io/attachmentgenie/temporal",
    version = "latest",
  }
}
