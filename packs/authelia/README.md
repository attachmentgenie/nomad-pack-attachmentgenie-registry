...
```
nomad-pack run authelia --var message="Hola Mundo!"
```
...
balance the Consul service `authelia-service`, which is the default value
...
- `consul_service_name` (string) - The consul service name for the authelia
  application
