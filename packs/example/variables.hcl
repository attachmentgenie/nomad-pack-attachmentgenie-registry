...
variable "service_name" {
  description = "The service name for the example application"
  type        = string
  default     = "example"
}
...
variable "task" {
  description = "Details configuration options for the example task."
  type = object({
    driver  = string
    image   = string
    version = string
  ...
  default = {
    driver  = "docker",
    image   = "ghcr.io/attachmentgenie/example",
    version = "latest",
  }
}
