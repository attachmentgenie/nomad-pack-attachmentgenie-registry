...
variable "service_name" {
  description = "The service name for the atlantis application"
  type        = string
  default     = "atlantis"
}
...
variable "task" {
  description = "Details configuration options for the atlantis task."
  type = object({
    driver  = string
    image   = string
    version = string
  ...
  default = {
    driver  = "docker",
    image   = "ghcr.io/attachmentgenie/atlantis",
    version = "latest",
  }
}
